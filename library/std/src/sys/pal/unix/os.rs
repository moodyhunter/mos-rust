...
extern "C" {
    #[cfg(not(any(target_os = "dragonfly", target_os = "vxworks", target_os = "mos")))]
    #[cfg_attr(
        any(
            target_os = "linux",
...
#[cfg(all(not(target_os = "dragonfly"), not(target_os = "vxworks"), not(target_os = "mos")))] // needed for readdir and syscall!
